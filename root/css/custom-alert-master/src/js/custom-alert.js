...
function customAlert(inGlobalVar) {
    ...
    function Alert() {
        ...
        this.render = function(dialog, options) {
            ...
            document.querySelector('#customalert-overlay').style.display =
                'block';
    ...
    function Confirm() {
        ...
        this.render = function(dialog, options) {
            ...
            if (options) {
                ...
                if (options.cancel) {
                    this.options.cancel = mergeObjects(
                        confirmDefaultOptions.cancel,
                        options.cancel
                    );
                }
                if (options.done) {
                    this.options.done = mergeObjects(
                        confirmDefaultOptions.done,
                        options.done
                    );
                }
                if (options.title) {
            ...
            confirmBox.querySelector('.button-cancel').innerHTML = getText(
                this.options,
                'cancel'
            );
            confirmBox.querySelector('.button-done').innerHTML = getText(
                this.options,
                'done'
            );
            document.querySelector('html').style.overflow = 'hidden';
            document.querySelector('#customconfirm-overlay').style.display =
                'block';
    ...
    if (document.getElementById('customalert') == null) {
        ...
        window.addEventListener(
            ...
            function(e) {
                ...
                if (
                    (customAlert == null && customConfirm == null) ||
                    (customConfirm != null &&
